...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form id="editOrdemServico" action="{{ route('ordensservicos.update',['ordemServico'=>$ordemServico->id]) }}" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <select class="form-control" name="contrato_id">
                        <option value="{{$ordemServico->contrato->id}}">{{$ordemServico->contrato->nomeContrato}}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    @php
                        $valorFormatado = number_format($ordemServico->valorOrdemServico,2,',','.');
                    @endphp
                    <input class="form-control" type="text" id="valorOrdemServico" name="valorOrdemServico" value="{{$valorFormatado}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control date-picker" type="text" name="dataOrdemServico"
                           placeholder="Data de Ordem de Serviço" value="{{$ordemServico->dataOrdemServico}}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" name="numeroOrdemServico"
                           placeholder="Número de Ordem de Serviço" value="{{$ordemServico->numeroOrdemServico}}">
                </div>
            </div>
            <div class="form-group row">
    ...
    <script>
        $(document).ready(function($) {
            ...
            $('#editOrdemServico').submit(function(event) {
